...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['n_notdogs_img'] = 0 # D 
    ...
    for key, value in results_dic.items():
        ...
        # Percentages
        # pct_match - percentage of correct matches ( Y/Z * 100 )
        # pct_correct_dogs - percentage of correctly classified dogs ( A/B * 100 )
        # pct_correct_breed - percentage of correctly classified dog breeds ( E/B * 100 )
        # pct_correct_notdogs - percentage of correctly classified NON-dogs ( C/D * 100 )
